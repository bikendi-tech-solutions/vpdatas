...
<div class="card">
                <div class="card-body">
                  <h5 class="card-title">Successful Data Card Printing</h5>

                  <?php

if(!isset($_GET["trans_id"])){
    pagination_history_before("sdatacard","true");
}
elseif(empty($_GET["trans_id"])){
  pagination_history_before("sdatacard","true");
    ...
    if(is_numeric($_GET["trans_id"])){
        $id = $_GET["trans_id"];
        pagination_history_before("sdatacard","true","AND id = '$id'");
    }
    else{
        $id = $_GET["trans_id"];
        pagination_history_before("sdatacard","true","AND request_id = '$id'");
    }
}
...
<label class="customcheckbox mb-3">
  ...
  <select onchange="openfunction('sdatacard','Data Cards',false)">
