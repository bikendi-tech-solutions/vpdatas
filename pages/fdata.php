...
<div class="card">
                <div class="card-body">
                  <h5 class="card-title">Failed Data Card Printing </h5>

                  <?php

if(!isset($_GET["trans_id"])){
    pagination_history_before("sdatacard","fals");
}
elseif(empty($_GET["trans_id"])){
  pagination_history_before("sdatacard","fals");
    ...
    if(is_numeric($_GET["trans_id"])){
        $id = $_GET["trans_id"];
        pagination_history_before("sdatacard","fals","AND id = '$id'");
    }
    else{
        $id = $_GET["trans_id"];
        pagination_history_before("sdatacard","fals","AND request_id = '$id'");
    }
}
...
foreach($transactions as $result){
    ...
    <button class='' onclick='reversetransaction(\"sdatacard\",\"".$result->id."\", \"".$result->user_id."\", \"".$result->amount."\");'> <li class=' fas fa-retweet'></li></button>
    <button class='' onclick='approvetransaction(\"sdatacard\",\"".$result->id."\", \"".$result->user_id."\", \"".$result->amount."\");'> <li class=' fas fa-retweet'></li></button>
    </div>
    </td>
...
<label class="customcheckbox mb-3">
  ...
  <select onchange="openfunction('sdatacard','Data Card',false)">
